 ...
 */
class TblLocation extends \Trax\AdminBundle\Entity\TblLocation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblLocation' . "\0" . 'zoneid', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblLocation' . "\0" . 'location', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblLocation' . "\0" . 'customerid', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblLocation' . "\0" . 'adminid', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblLocation' . "\0" . 'createdat'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TblLocation $proxy) {
