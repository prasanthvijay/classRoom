 ...
 */
class TblBasicdetails extends \Trax\AdminBundle\Entity\TblBasicdetails implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblBasicdetails' . "\0" . 'id', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblBasicdetails' . "\0" . 'name', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblBasicdetails' . "\0" . 'managername', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblBasicdetails' . "\0" . 'chorusid', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblBasicdetails' . "\0" . 'gid', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblBasicdetails' . "\0" . 'location', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblBasicdetails' . "\0" . 'department', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblBasicdetails' . "\0" . 'gender', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblBasicdetails' . "\0" . 'customerid', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblBasicdetails' . "\0" . 'adminid', '' . "\0" . 'Trax\\AdminBundle\\Entity\\TblBasicdetails' . "\0" . 'createdat'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TblBasicdetails $proxy) {
