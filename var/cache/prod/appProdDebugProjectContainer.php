...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('OBqFXh8wzG', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ex8qB4V8cT', 0, 'HJNpZ2StRjt-oTy+dMv0ua', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'MichelinClassroomDB', 'user' => 'root', 'password' => 'console', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Trax/AdminBundle/Entity'))), 'Trax\\AdminBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('TraxAdminBundle' => 'Trax\\AdminBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bc9a324e4c3d9173ad27f23d0dac328ca7892a7d5e63b8d7f632c1426d8d8dd2');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('q6kT-zwHmV', NULL, 'HJNpZ2StRjt-oTy+dMv0ua', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Trax/AdminBundle/Resources/views'), 'TraxAdmin');
        $instance->addPath(($this->targetDirs[3].'/src/Trax/UserBundle/Resources/views'), 'TraxUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('94502cb9206c3568862bfc77238c2163111ca0df');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('S14cep1Rhj', 0, 'HJNpZ2StRjt-oTy+dMv0ua', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5982a7a59019b5.76245532')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'TraxAdminBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Trax/AdminBundle'),
                    'namespace' => 'Trax\\AdminBundle',
                ),
                'TraxUserBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Trax/UserBundle'),
                    'namespace' => 'Trax\\UserBundle',
                ),
            ); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TraxAdminBundle' => 'Trax\\AdminBundle\\TraxAdminBundle',
                'TraxUserBundle' => 'Trax\\UserBundle\\TraxUserBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdDebugProjectContainer',
            'database_host' => 'localhost',
            'database_port' => NULL,
            'database_name' => 'MichelinClassroomDB',
            'database_user' => 'root',
            ...
            'secret' => '94502cb9206c3568862bfc77238c2163111ca0df',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '94502cb9206c3568862bfc77238c2163111ca0df',
